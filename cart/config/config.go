...
type Config struct {
	...
	MongoDBName             string `env:"MONGODB_NAME" envDefault:"cart"`
	MongoDBTableName 		string `env:"MONGODB_TABLE_NAME" envDefault:"cart"`
	...
	GRPCAuthenHost string `env:"GRPC_SENDER_HOST" envDefault:"localhost:50057"`
}
