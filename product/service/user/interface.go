...
type Service interface {
	...
	ReadStock(input *userin.ReadInput) (a interface{}, err error)
	ReportSale(ctx context.Context, input *userin.ReportRange)
	ReportStock(input *userin.ReportFilter)
	ReadNameStock(input *userin.ReadNameAllInput) (a interface{}, err error)
	ReadCategoryStock(input *userin.ReadCategoryAllInput) (a interface{}, err error)
