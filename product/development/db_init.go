...
var MenuList =  []Menu2{
	...
	{[]string{"Milk", "Frappe"},  "Fresh Milk Frappe", []Ingredient{{"Milk", 004}, {"Ice", 005},{"Plastic cup", 100}}, 5000, true,1,""},
	{[]string{"Chocolate", "Hot"},  "Hot Chocolate (Small)", []Ingredient{{"Chocolate", 001},Ingredient{"Milk", 004}, {"Small hot cup", 100}}, 4000, true,2,""},
	{[]string{"Chocolate", "Hot"},  "Hot Chocolate (Large)", []Ingredient{{"Chocolate", 002},Ingredient{"Milk", 007}, {"Large hot cup", 100}}, 5000, true,1,""},
	{[]string{"Chocolate", "Iced"},  "Iced Chocolate", []Ingredient{{"Chocolate", 001},Ingredient{"Milk", 004}, {"Ice", 005},{"Plastic cup", 100}}, 5000, true,1,""},
	{[]string{"Chocolate", "Frappe"},  "Chocolate Frappe", []Ingredient{{"Chocolate", 001},Ingredient{"Milk", 004}, {"Ice", 005},{"Plastic cup", 100}}, 5500, true,2,""},
	{[]string{"Juice", "Iced"},  "Lychee Juice", []Ingredient{{"Lychee Juice", 015}, {"Ice", 005}, {"Plastic cup", 100}}, 4000, true,3,""},
	{[]string{"Juice", "Smoothies", "Frappe"},  "Lychee Frappe", []Ingredient{{"Lychee Juice", 015}, {"Ice", 005}, {"Plastic cup", 100}}, 4500, true,2,""},
	{[]string{"Juice", "Smoothies", "Frappe"},  "Strawberry Frappe", []Ingredient{{"Strawberry Juice", 015}, {"Ice", 005}, {"Plastic cup", 100}}, 5500, true,1,""},
	{[]string{"Juice", "Smoothies", "Frappe"},  "Kiwi Frappe", []Ingredient{{"Kiwi Juice", 015}, {"Ice", 005}, {"Plastic cup", 100}}, 4500, true,1,""},
}
