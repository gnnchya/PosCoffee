...
func (wrp wrapper) List(ctx context.Context, opt *domain.PageOption) (total int, list []*out.RolesView, err error) {
	sp, ctx := opentracing.StartSpanFromContext(ctx, "service.roles.List")
	defer sp.Finish()
