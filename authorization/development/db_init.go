...
var PermissionList =  []Permissions{
	...
	{"0008",  "POST", "/pos/menu/:role", timeNow ,0, nil},
	{"0009",  "PUT", "/pos/menu/:role", timeNow ,0, nil},
	{"0010",  "DELETE", "/pos/menu/:id/:role", timeNow ,0, nil},
	{"0011",  "GET", "/pos/menu/:id/:role", timeNow ,0, nil},
	{"0012",  "GET", "/pos/menu", timeNow ,0, nil},
	{"0013",  "GET", "/pos/menu/search/:role", timeNow ,0, nil},
	{"0014",  "GET", "/pos/menu/category/:role", timeNow ,0, nil},
	{"0015",  "GET", "/pos/menu/ingredients/:role", timeNow ,0, nil},
