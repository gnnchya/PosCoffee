...
func New(validator validator.Validator, elasRepo util.RepositoryElas, client grpcClient.Service) (service user.Service) {
	return &implementation{validator, elasRepo, client}
}
