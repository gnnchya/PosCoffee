...
type RequestToStock struct {
	...
	Ingredient []*IngredientToStock `protobuf:"bytes,1,rep,name=ingredient,proto3" json:"ingredient,omitempty"`
}
...
func (x *RequestToStock) GetIngredient() []*IngredientToStock {
	if x != nil {
		return x.Ingredient
	}
	return nil
...
func (x *IngredientToStock) Reset() {
	*x = IngredientToStock{}
	if protoimpl.UnsafeEnabled {
...
func (x *IngredientToStock) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IngredientToStock) ProtoMessage() {}

func (x *IngredientToStock) ProtoReflect() protoreflect.Message {
	mi := &file_protobuf_product_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IngredientToStock.ProtoReflect.Descriptor instead.
func (*IngredientToStock) Descriptor() ([]byte, []int) {
	return file_protobuf_product_proto_rawDescGZIP(), []int{3}
}

func (x *IngredientToStock) GetIngredientName() string {
	if x != nil {
...
func (x *IngredientToStock) GetAmount() int64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_protobuf_product_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x22, 0x49, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x6f, 0x53,
	0x74, 0x6f, 0x63, 0x6b, 0x12, 0x37, 0x0a, 0x0a, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x64, 0x69, 0x65,
	0x6e, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e,
	0x69, 0x6e, 0x67, 0x72, 0x65, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x54, 0x6f, 0x53, 0x74, 0x6f, 0x63,
	0x6b, 0x52, 0x0a, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x53, 0x0a,
	0x11, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x54, 0x6f, 0x53, 0x74, 0x6f,
	0x63, 0x6b, 0x12, 0x26, 0x0a, 0x0e, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x64, 0x69, 0x65, 0x6e, 0x74,
	...
	0x6e, 0x74, 0x32, 0x50, 0x0a, 0x0f, 0x53, 0x65, 0x6e, 0x64, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x64,
	...
	0x74, 0x6f, 0x63, 0x6b, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70,
...
var file_protobuf_product_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_protobuf_product_proto_goTypes = []interface{}{
	...
	(*IngredientToStock)(nil), // 3: cart.ingredientToStock
}
var file_protobuf_product_proto_depIdxs = []int32{
	1, // 0: cart.ReplyFromStock.calculateCost:type_name -> cart.CalculateCost
	3, // 1: cart.RequestToStock.ingredient:type_name -> cart.ingredientToStock
...
func file_protobuf_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protobuf_product_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IngredientToStock); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
