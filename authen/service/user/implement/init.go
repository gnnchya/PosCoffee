...
func New(validator validator.Validator, repo util.RepositoryUsers, filter util.Filters, grpc grpcClient.Service) (service user.Service) {
	return &implementation{validator, repo, filter, grpc}
}
